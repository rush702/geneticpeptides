...
const ENTERPRISE_FEATURES_SHORT = [
  ...
  "Custom Finnrick data integration",
...
export default function ForVendorsPage() {
  ...
  const enterprisePrice = billingAnnual ? 399 : 599;
  const annualTotal = 4792;
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {/* ── Free Tier ── */}
            <div className={`rounded-2xl border p-7 ${cardBg} ${borderColor}`}>
              <div className="mb-5">
            ...
            {/* ── Enterprise Tier ── */}
            <div className="relative rounded-2xl border-2 border-emerald-500/50 p-7 bg-gradient-to-b from-emerald-500/5 to-transparent">
              ...
              <div className="mb-5 mt-1">
                <span className="text-xs font-bold px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400">ENTERPRISE</span>
              </div>
              ...
              {billingAnnual ? (
                <p className={`text-sm mb-6 ${textMuted}`}>
                  ${annualTotal.toLocaleString()}/year &bull; <span className="text-emerald-400 font-medium">Save $1,396/year (20%)</span>
                </p>
              ) : (
                <p className={`text-sm mb-6 ${textMuted}`}>or $4,792/year billed annually — save 20%</p>
              )}
              <ul className="space-y-3 mb-8">
